...
import { CheckCircle, Calendar, Clock, MapPin, Mail, Phone, Download } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-gray-600 mb-8">We couldn't find your registration information.</p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Registration Confirmed!</h1>
          <p className="text-xl text-gray-600">
            Thank you for registering. We've sent a confirmation email to {registrationData.email}
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-lg font-bold text-primary">{confirmationNumber}</p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex">
                    ...
                    <span className="text-gray-900">{registrationData.firstName} {registrationData.lastName}</span>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900">{registrationData.phone}</span>
                  </div>
                  {registrationData.company && (
                    <div className="flex">
                      <span className="text-gray-600 w-24">Company:</span>
                      <span className="text-gray-900">{registrationData.company}</span>
                    </div>
                  )}
                  {registrationData.jobTitle && (
                    <div className="flex">
                      <span className="text-gray-600 w-24">Job Title:</span>
                      <span className="text-gray-900">{registrationData.jobTitle}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex">
                    ...
                    <span className="text-gray-900 capitalize">{registrationData.ticketType}</span>
                  </div>
                </div>
              </div>

              {/* Additional Information */}
              {(registrationData.dietaryRestrictions || registrationData.emergencyContact) && (
                <div>
                  <h3 className="font-semibold text-gray-900 mb-3">Additional Information</h3>
                  <div className="space-y-2 text-sm">
                    {registrationData.dietaryRestrictions && (
                      <div>
                        <span className="text-gray-600 block mb-1">Dietary Restrictions:</span>
                        <span className="text-gray-900">{registrationData.dietaryRestrictions}</span>
                      </div>
                    )}
                    {registrationData.emergencyContact && (
                      <div>
                        <span className="text-gray-600 block mb-1">Emergency Contact:</span>
                        <span className="text-gray-900">{registrationData.emergencyContact}</span>
                      </div>
                    )}
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>• Event details and joining instructions will be sent 24 hours before</li>
        ...
        <div className="mt-12 bg-gray-50 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            If you have any questions about your registration or the event, don't hesitate to contact us.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 text-sm">
            <a href="mailto:support@eventhub.com" className="text-primary hover:text-primary/80 transition-colors">
